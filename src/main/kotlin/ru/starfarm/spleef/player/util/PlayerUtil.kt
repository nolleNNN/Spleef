...
val String.colored: String get() = ChatUtil.color(this)
...
fun Player.sendPlayerTitle(upperMessage: String, lowerMessage: String) = sendTitle(upperMessage.colored, lowerMessage.colored, 10, 20, 10)
